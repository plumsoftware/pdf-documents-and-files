    ...
    Column(
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(id = R.string.favorites_button_content_desc)
            )
        }
        Text(
            text = stringResource(id = R.string.favorites_button),
...
private fun FavoritesButtonPreview() {
    PdfTheme {
        Scaffold {
            FavoritesButton(onClick = {}, isSelected = false)
        }
    }
}