...
@Composable
fun SettingsButton(onClick: () -> Unit, modifier: Modifier = Modifier, isSelected: Boolean = false) {
    val contentColor =
    ...
    Column(
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(id = R.string.settings_button_content_desc)
            )
        }
        Text(
...
private fun RecentButtonPreview() {
    PdfTheme {
        Scaffold {
            SettingsButton(onClick = {}, isSelected = true)
        }
    }
}